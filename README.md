...
Платежная система включает набор тестов для проверки правильной работы различных сценариев:

1. **Тест отправки уведомлений о платежах** - проверяет, что уведомления о транзакциях отправляются корректно.
2. **Тест пополнения баланса** - проверяет успешное зачисление средств.
3. **Тест списания средств** - проверяет корректное списание средств с баланса.
4. **Тест обработки недостатка средств** - проверяет поведение системы при недостаточном балансе.
