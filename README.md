...
## Конфигурация Nginx и Webhook

⚠️ **ВАЖНО:** Вся документация по конфигурации Nginx, вебхуков и связанной инфраструктуры перемещена в единый файл:

**[docs/NGINX_CONFIGURATION.md](/docs/NGINX_CONFIGURATION.md)**

Пожалуйста, обращайтесь к этому файлу для получения актуальной информации о настройке серверной инфраструктуры. Любые изменения в конфигурации должны быть задокументированы только в этом файле.

## 📞 Поддержка

При возникновении вопросов обращайтесь к разделу Issues в репозитории или к автору проекта.
