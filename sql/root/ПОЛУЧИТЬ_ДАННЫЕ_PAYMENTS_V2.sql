-- ================================================================================
-- ПОЛУЧИТЬ ВСЕ ДАННЫЕ ИЗ ТАБЛИЦЫ payments_v2 - КОРРЕКТНЫЙ АНАЛИЗ
...
-- 2. АГРЕГИРОВАННЫЕ ДАННЫЕ ПО КАЖДОМУ БОТУ
SELECT
  bot_name,
...
-- 3. ПРОВЕРКА HaimGroupMedia_bot (100,000 STARS)
SELECT
  bot_name,
  type,
  category,
...
-- 5. Отправьте мне - я создам корректный Excel с правильным названием таблицы payments_v2
-- ================================================================================