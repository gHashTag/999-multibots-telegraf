...
- **Статус:** ⏳ Диагностика "Выбор модели ИИ".
- **Проблемы (от простых к сложным):**
    *   ✅ Справка (Без ответа) - *Исправлено 28.04.2025*
    *   ❌ Выбор модели ИИ (Нет ответа)
    *   ❌ Текст в фото (Сообщение о временной недоступности)
...
- **Следующие шаги:**
    - Исследовать причину отсутствия ответа от функции "Выбор модели ИИ" (`selectModelCommand`, `selectModelWizard`).
    - Проверить обработчики нажатий кнопок выбора модели.
    - Проверить логи на наличие ошибок при выборе модели.
