...
- **Следующие шаги:**
    - Исследовать причину отсутствия ответа от команды/сцены "Справка" (`/help`, `helpScene`).
    - Проверить, зарегистрирована ли команда/сцена и есть ли обработчик.
    - Проверить логи на наличие ошибок при вызове справки.
