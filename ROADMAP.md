...
2.  **[✅] Упростить логику отправки уведомлений в `startScene`**
    ...
    *   [✅] Проверить вручную на тестовом боте (`ai_koshey_bot`).
        *   [✅] Случай без реферала.
        *   [✅] Случай с рефералом.
    *   [✅] Слить изменения *только* этой задачи в `main`.
3.  **[⏳] Запустить Prettier и ESLint для всего проекта**
    *   [✅] Запустить `pnpm prettier --write .`
    *   [✅] Запустить `pnpm lint`
    *   [❌] Исправить оставшиеся предупреждения ESLint (51 warning).
4.  **[⏳] Проверить и исправить тесты в других файлах**
