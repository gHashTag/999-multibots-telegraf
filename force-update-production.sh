...
echo ""
echo "=================================================================="
log_info "🚨 ПРИНУДИТЕЛЬНОЕ ОБНОВЛЕНИЕ ПРОДАКШН"
echo "=================================================================="
echo ""
...
ssh_exec "
    ...
    git log --oneline -1
    echo ''
    echo '=== ПРОВЕРКА registerCommands.ts ==='
    grep -A 5 'voiceAvatarWizard,' src/registerCommands.ts
"

# 2. Остановка контейнера
log_info "2. Остановка контейнера..."
ssh_exec "
...
# 5. Ожидание
log_info "5. Ожидание инициализации (40 сек)..."
sleep 40
...
ssh_exec "
    ...
    echo ''
    echo '=== ЛОГИ (последние 40 строк) ==='
    docker logs 999-multibots --tail 40 2>&1 | tail -20
"
