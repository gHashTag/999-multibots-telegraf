...
export function createDefaultTracks(
  ...
  const coverFrames = Math.floor(
    (DEFAULT_TEMPLATE.coverDuration || DEFAULT_COVER_DURATION) * fps
  )
...
export const CAPTION_DEFAULTS = {
  ...
  highlightColor: '#00ff88', // t27 neon green
...
export const BRAND_COLORS = {
  amber: '#00ff88', // Primary brand color (t27.ai neon green)
  amberLight: '#4dffab', // Hover/light variant
  amberDark: '#00cc66', // Dark variant
...
const getRemotionWsHost = () =>
  SERVICE_ENDPOINTS.remotion.replace('https://', '')
...
export const SCRIPT_STYLE_OPTIONS = [
  ...
  {
    value: 'entertaining' as const,
    labelRu: 'Развлекательный',
    labelEn: 'Entertaining',
    emoji: '🎉',
  },
  {
