...
import { Sparkles, Loader2, Image, Video, Music, Mic, AlertCircle, Upload, Square, Trash2, RefreshCw, GripVertical, Plus, Share } from 'lucide-react';
import { generateImage, generateImageViaReplicate, generateVideo, generateAudio, generateLipsync } from '@/lib/generateApi';
...
const IMAGE_MODELS: ImageModel[] = [
  ...
  { id: 'replicate:stability-ai/sdxl:7762fd07cf82c948538e41f63f77d685e02b063e37e496e96eefd46c929f9bdc', name: 'SDXL', description: 'Replicate • Standard' },
  { id: 'replicate:bytedance/sdxl-lightning-4step:6f7a773af6fc3e8de9d5a3c00be77c17308914bf67772726aff83496ba1e3bbe', name: 'SDXL Lightning', description: 'Replicate • Fast (4-step)' },
  { id: 'replicate:fofr/sdxl-emoji:dee76b5afde21b0f01ed7925f0665b7e879c50ee718c5f78a9d38e04d523cc5e', name: 'SDXL Emoji', description: 'Replicate • Sticker style' },
];
...
export function GeneratePanel({ activeTab: externalTab }: GeneratePanelProps) {
  ...
  const [publishThumbnailUrl, setPublishThumbnailUrl] = useState<string | undefined>();
  ...
  const [imagePrefilledPrompt, setImagePrefilledPrompt] = useAtom(imagePrefilledPromptAtom);
  const [avatarPrefilledText, setAvatarPrefilledText] = useAtom(avatarPrefilledTextAtom);
  ...
  const [videoPrefilledPrompts, setVideoPrefilledPrompts] = useAtom(videoPrefilledPromptsAtom);
