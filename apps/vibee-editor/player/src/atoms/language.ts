...
const en: Translations = {
  ...
  'pricing.subtitle': 'Create your first reels without a credit card',
  'pricing.free.name': 'Free',
  'pricing.free.price': '$0',
  'pricing.free.period': '/month',
  'pricing.free.feature1': '3 reels per month',
  'pricing.free.feature2': 'All AI models',
  'pricing.free.feature3': 'With watermark',
  'pricing.free.feature4': 'Community support',
  'pricing.free.cta': 'Start Free',
  'pricing.pro.name': 'Pro',
  'pricing.pro.price': '$19',
  'pricing.pro.period': '/month',
  'pricing.pro.feature1': 'Unlimited reels',
  'pricing.pro.feature2': 'All AI models',
  'pricing.pro.feature3': 'No watermark',
  'pricing.pro.feature4': 'Priority support',
  'pricing.pro.feature5': '4K export',
  'pricing.pro.cta': 'Go Pro',
  'pricing.pro.popular': 'Popular',
  'pricing.business.name': 'Team',
  'pricing.business.price': '$49',
  'pricing.business.period': '/month',
  'pricing.business.feature1': 'Everything in Pro',
  'pricing.business.feature2': '5 team members',
  'pricing.business.feature3': 'Shared assets',
  'pricing.business.feature4': 'Team analytics',
  'pricing.business.feature5': 'Dedicated manager',
  'pricing.business.cta': 'For Teams',
  ...
  'chat.clearFailed':
    'Could not clear the shared conversation. Please try again.',
  'chat.openTask': 'Open {task}',
  'chat.action.chat': 'agent',
  'chat.action.script': 'script',
  'chat.action.audio': 'audio',
  'chat.action.image': 'images',
  'chat.action.avatar': 'avatar',
  'chat.action.video': 'video',
  'chat.action.editor': 'editor',
  'chat.action.profile': 'profile',
  'chat.action.plan': 'content plan',
  'chat.action.files': 'files',
  'chat.action.skills': 'skills',
  'chat.chat': 'Chat',
  'chat.logs': 'Logs',
...
const ru: Translations = {
  ...
  // Pricing
  'pricing.badge': 'Цены',
  'pricing.title': 'Начни бесплатно',
  'pricing.subtitle': 'Создай первые рилсы без банковской карты',
  'pricing.free.name': 'Бесплатно',
  'pricing.free.price': '$0',
  'pricing.free.period': '/месяц',
  'pricing.free.feature1': '3 рилса в месяц',
  'pricing.free.feature2': 'Все AI модели',
  'pricing.free.feature3': 'С водяным знаком',
  'pricing.free.feature4': 'Поддержка сообщества',
  'pricing.free.cta': 'Начать бесплатно',
  'pricing.pro.name': 'Pro',
  'pricing.pro.price': '$19',
  'pricing.pro.period': '/месяц',
  'pricing.pro.feature1': 'Безлимитные рилсы',
  'pricing.pro.feature2': 'Все AI модели',
  'pricing.pro.feature3': 'Без водяного знака',
  'pricing.pro.feature4': 'Приоритетная поддержка',
  'pricing.pro.feature5': 'Экспорт 4K',
  'pricing.pro.cta': 'Выбрать Pro',
  'pricing.pro.popular': 'Популярный',
  'pricing.business.name': 'Команда',
  'pricing.business.price': '$49',
  'pricing.business.period': '/месяц',
  'pricing.business.feature1': 'Всё из Pro',
  'pricing.business.feature2': '5 участников',
  'pricing.business.feature3': 'Общие ассеты',
  'pricing.business.feature4': 'Командная аналитика',
  'pricing.business.feature5': 'Личный менеджер',
  'pricing.business.cta': 'Для команд',
  ...
  'chat.clearFailed': 'Не удалось очистить общий разговор. Попробуйте ещё раз.',
  'chat.openTask': 'Открыть: {task}',
  'chat.action.chat': 'агент',
  'chat.action.script': 'сценарий',
  'chat.action.audio': 'аудио',
  'chat.action.image': 'картинки',
  'chat.action.avatar': 'аватар',
  'chat.action.video': 'видео',
  'chat.action.editor': 'редактор',
  'chat.action.profile': 'профиль',
  'chat.action.plan': 'контент-план',
  'chat.action.files': 'файлы',
  'chat.action.skills': 'навыки',
  'chat.chat': 'Чат',
  'chat.logs': 'Логи',
