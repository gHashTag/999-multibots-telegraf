...
const en: Translations = {
  ...
  "hero.subtitle": "Social network for creators. AI generates professional videos. Upload a photo, describe an idea — get a ready-made reel.",
  "cta.try": "Try Free",
  "cta.demo": "Watch Demo",
  ...
  "feedPreview.subtitle": "Watch, like, and get inspired by the best reels from our community",
  ...
  "features.reels.desc": "Describe an idea — get a script, video, and voiceover in 2 minutes",
  "features.feed.title": "Creator Feed",
  "features.feed.desc": "Watch, like, and get inspired by the best community reels",
  "features.avatars.title": "Talking Avatars",
  "features.avatars.desc": "Create your digital twin that speaks with your voice",
  ...
  "creatorShowcase.subtitle": "Thousands of creators are already making money with VIBEE",
  "creatorShowcase.followers": "Followers",
  "creatorShowcase.reels": "Reels",
  "creatorShowcase.quote1": "VIBEE changed my content game. I create 5 reels a day now!",
  "creatorShowcase.quote2": "The AI avatars are mind-blowing. My audience loves them.",
  "creatorShowcase.quote3": "Finally a tool that makes professional video accessible to everyone.",
  ...
  "testimonials.quote1": "I used to spend hours editing. Now I create a reel in 2 minutes. This is a game changer!",
  "testimonials.quote2": "Our team's productivity tripled. VIBEE saves us tons of time and budget.",
  "testimonials.quote3": "The AI avatars look so realistic! My subscribers can't tell the difference.",
  "testimonials.quote4": "Simple interface, powerful result. Recommend to anyone who creates content.",
  ...
  "howItWorks.step1.desc": "Tell us what you want to create. AI will write the script.",
  "howItWorks.step2.title": "Choose the style",
  "howItWorks.step2.desc": "Select avatar, voice, music, and visual style for your reel.",
  "howItWorks.step3.title": "Publish",
  "howItWorks.step3.desc": "Share to Instagram, TikTok, YouTube, or the VIBEE feed.",
  ...
  "token.hero.tagline": "Compiler enforces @spec. Built-in payments. BEAM fault tolerance. Accept All without fear.",
  "token.hero.description": "45% of AI code has security vulnerabilities. VIBEE compiles AI-generated code into reliable BEAM agents with mandatory @spec checks and built-in payment layer. 10 lines of VIBEE vs 120 lines of Java.",
  ...
  "token.hero.karpathy.quote": "\"It's not really coding - I just see things, say things, run things, and copy-paste things, and it mostly works.\"",
  "token.hero.karpathy.cite": "— Andrej Karpathy (coined 'Vibe Coding', February 2025)",
  ...
  "token.killer.subtitle": "One YAML file → Production-ready code automatically",
  "token.killer.description": "Write behaviors in plain English. Get complete plugins with tests, docs, and type safety. This is what makes VIBEE worth billions.",
  ...
  "token.killer.how.step1.desc": "Describe behaviors in plain English with test cases",
  ...
  "token.killer.how.step3.desc": "Functions, tests, docs, types - all generated",
...
types:
  ...
  "token.vibe.definition": "Term coined by Andrej Karpathy (OpenAI, Tesla) in February 2025. Developers fully trust AI to write code, clicking 'Accept All' without reading diffs. Fast but risky: 45% of AI code has security vulnerabilities.",
  ...
  "token.vibe.conclusion.text": "Rules are embedded in the language grammar, not in prompts.",

  // Origin Story
  "token.origin.title": "I understood the vibe coding problem before the term existed",
  "token.origin.ch1.title": "Vibe coding = full trust in AI",
  "token.origin.ch1.quote": "\"I worked with LLM agents long before the term 'vibe coding'. And every time the same problem: AI ignores the rules you give it. I write 'tests first' — it forgets. Again and again.\"",
  "token.origin.ch1.explanation": "Prompts don't work. Context is lost. Rules are bypassed. This is the main problem with vibe coding — no enforcement.",
  "token.origin.ch2.title": "@spec = safety net for vibe coding",
  "token.origin.ch2.quote": "\"When you click Accept All in Cursor or Claude Code, AI code goes to the VIBEE compiler. No @spec — code won't compile. It's physically impossible to deploy an untested agent.\"",
  ...
  "token.origin.ch3.quote": "\"AI rarely adds retry, timeout, circuit breaker. In VIBEE it's one line — a decorator. Accept All and get production-ready code.\"",
  "token.origin.conclusion": "VIBEE is the only DSL where vibe coding becomes safe. Rules in grammar, not in prompts.",
  ...
  "token.problem.security.text": "SQL Injection, XSS, Command Injection — top LLM errors. Veracode 2025: almost half of AI code is unsafe.",
  "token.problem.hangover.title": "Vibe coding hangover",
  "token.problem.hangover.text": "SaaStr incident: AI agent deleted production database. Without checks, AI can do anything.",
  "token.problem.gap.title": "Comprehension gap",
  "token.problem.gap.text": "Developers don't understand the AI code they deploy. When it breaks — they don't know how to fix it.",

  // Fail Section
  "token.fail.title": "Why current frameworks don't work",
  "token.fail.config.title": "Config files without guarantees",
  "token.fail.config.text": "Chaining libraries don't provide formal behavior guarantees: prompt changes — everything breaks.",
  "token.fail.tests.title": "Tests are optional",
  "token.fail.tests.text": "You can deploy an agent without a single check. No enforced TDD/BDD.",
  "token.fail.payments.title": "Payments are separate",
  "token.fail.payments.text": "Payments and security are always \"bolted on\" separately, no unified transaction model.",

  // Solution Section
  "token.solution.title": "Vibe code boldly — @spec catches errors",
  "token.solution.p1.bold": "VIBEE is a DSL for safe vibe coding.",
  "token.solution.p1.text": "When AI generates code, it goes to a compiler that requires @spec for every tool/agent.",
  "token.solution.p2.text": "You can click Accept All as much as you want — without a Given–When–Then specification,",
  "token.solution.p2.bold": "the code physically won't compile.",
  "token.solution.p3": "The output is a production-ready agent on BEAM VM with 99.9999999% uptime. Even vibe-coded.",

  // Code Comparison
  "token.code.title": "Vibe code faster with VIBEE",
  "token.code.subtitle": "Less code = fewer places for AI errors. 10 lines VIBEE vs 120 lines Java.",
  "token.code.note": "VIBEE automatically generates boilerplate, error handling, retry logic and types. Developer writes only business logic.",

  // Compilation
  "token.compilation.title": "What VIBEE compiles to",
  "token.compilation.subtitle": "VIBEE DSL → Gleam → BEAM bytecode. See the transformation.",
  ...
  "token.compilation.note": "10 lines of VIBEE become ~30 lines of typed Gleam code with retry, cache, timeout and error handling. Output: fault-tolerant BEAM process.",

  // Syntax Comparison
  "token.syntax.title": "🔬 VIBEE Language Syntax Comparison",
  "token.syntax.subtitle": "All 25 syntax features with real code examples - Click tabs to explore",
  ...
  "token.syntaxShowcase.subtitle": "Powerful features that exist only in VIBEE - giving you superpowers other languages don't have",
  ...
  "token.uniqueFeature.4pipes.desc": "Most languages have 0-1 pipe operators. VIBEE has 4 specialized variants for different use cases.",
  ...
  "token.uniqueFeature.52decorators.desc": "Most languages have 0-10 decorators. VIBEE has 52 production-ready decorators for AI agents.",
  "token.uniqueFeature.operatorSections.title": "Operator Sections",
  "token.uniqueFeature.operatorSections.desc": "Partial application of operators - write (> 5) instead of fn(x) { x > 5 }",
  ...
  "token.decorators.subtitle": "AI rarely adds retry, timeout, circuit breaker. In VIBEE — it's one line. 12 decorators, 6,500+ usages.",
  ...
  "token.decorators.spec.desc": "TDD-first: code won't compile without specification (Given-When-Then)",
  "token.decorators.impl.usage": "1,484 usages",
  "token.decorators.impl.desc": "Implementation marker after @spec. Links specification to code.",
  "token.decorators.retry.usage": "188 usages",
  "token.decorators.retry.desc": "Automatic retries with exponential/linear/constant backoff",
  "token.decorators.timeout.usage": "170 usages",
  "token.decorators.timeout.desc": "Execution time limit. Protection from hanging calls.",
  "token.decorators.circuit.usage": "138 usages",
  "token.decorators.circuit.desc": "\"Circuit breaker\" pattern — protection from cascade failures",
  "token.decorators.cache.usage": "158 usages",
  "token.decorators.cache.desc": "ETS caching with TTL. Instant access to hot data.",
  "token.decorators.builder.usage": "403 usages",
  "token.decorators.builder.desc": "Builder pattern + automatic to_json() method",
  "token.decorators.derive.usage": "231 usages",
  "token.decorators.derive.desc": "Automatic JSON serialization/deserialization",
  ...
  "token.decorators.llm.desc": "LLM provider connection. Support for 19+ models.",
  "token.decorators.telegram.usage": "150+ usages",
  "token.decorators.telegram.desc": "Telegram MTProto integration. Bot API and UserBot modes.",
  "token.decorators.http.usage": "80+ usages",
  "token.decorators.http.desc": "Declarative HTTP requests. REST API in one line.",
  "token.decorators.paywall.usage": "50+ usages",
  "token.decorators.paywall.desc": "Payment gateway before action. Crypto + fiat + Telegram Stars.",
  "token.decorators.fullExampleTitle": "Full example: Escrow agent for marketplace",

  // Demo
  "token.demo.title": "Example: marketplace agent in 15 minutes",
  "token.demo.intro": "Imagine a digital services marketplace. Sellers and buyers talk to an agent: it helps find a performer, agree on price, lock money in escrow and automatically pay after task completion.",
  ...
  "token.demo.result": "Developer gets not a \"chatbot\" but an industrial component ready for production.",

  // Features
  "token.features.title": "Product — what VIBEE consists of",
  "token.features.dsl.title": "VIBEE DSL",
  "token.features.dsl": "Language for describing agent logic and constraints with mandatory specifications.",
  "token.features.beam.title": "BEAM Runtime",
  "token.features.beam": "Cluster with auto-recovery, millions of lightweight processes and 99.9999999% uptime.",
  "token.features.mcp.title": "MCP Native",
  "token.features.mcp": "Deep integrations with Claude, Cursor and developer tools.",
  "token.features.payments.title": "Payments Layer",
  "token.features.payments": "Crypto, fiat, P2P escrow — managed by agent according to set rules.",
  "token.features.devex.title": "Dev Experience",
  "token.features.devex": "CLI, SDK, one-command deploy, CI/CD and test runner integrations.",
  "token.features.rainbow.title": "Rainbow Bridge",
  "token.features.rainbow": "E2E tests on real Telegram accounts. Not mocks — live checks.",

  // ICP
  "token.icp.title": "Who we're building VIBEE for",
  "token.icp.saas.badge": "B2B SaaS",
  "token.icp.saas": "Companies that want to embed agents in their product (support, sales, ops) with controlled behavior.",
  "token.icp.fintech.badge": "Fintech & Marketplaces",
  "token.icp.fintech.text": "Platforms with transactions where agent must manage money by strict rules.",
  "token.icp.agencies.badge": "Studios & Agencies",
  "token.icp.agencies.text": "Teams building custom AI agents for clients who want an industrial stack.",

  // Moat
  "token.moat.title": "Why this is hard to replicate",
  "token.moat.dsl.title": "Only compiled DSL for AI agents on BEAM",
  "token.moat.dsl.text": "Competitors are libraries and configs, not languages.",
  "token.moat.tdd.title": "Enforced TDD/BDD",
  "token.moat.tdd.text": "Specification and test requirements are built into the architecture before compilation.",
  "token.moat.payments.title": "Native payments and escrow layer",
  "token.moat.payments.text": "Not just \"connect Stripe\" but a unified money model in DSL.",
  "token.moat.templates.title": "Accumulation of domain templates",
  "token.moat.templates.text": "Over time VIBEE accumulates ready \"agents by industry\", strengthening moat.",

  // Business
  "token.business.title": "How VIBEE makes money",
  "token.business.saas.title": "Subscription (SaaS)",
  "token.business.saas.text": "Plans by number of agents, integrations, transactions and environment (dev/prod).",
  "token.business.month": "mo",
  "token.business.usage.title": "Usage-based",
  "token.business.usage.text": "Small commission on payments and escrow operations passing through agents.",
  "token.business.enterprise.title": "Enterprise",
  "token.business.enterprise.text": "On-prem/private clusters, SLA, consulting and custom integrations.",
  ...
  "token.market.p1": "AI agents market is growing at ~46% CAGR, with total volume estimated at $69 billion by 2034.",
  "token.market.p2": "Investors are shifting from \"bare LLMs\" to infrastructure and devtools that enable reliable products on top of models.",
  ...
  "token.competitors.langchainDesc": "Most popular LLM framework. Great ecosystem, but no compile-time safety.",
  "token.competitors.autogenDesc": "Multi-agent conversations. Strong Azure integration, but Python runtime.",
  "token.competitors.crewaiDesc": "Role-based multi-agent. Simple API, but only sequential workflows.",
  "token.competitors.elizaosDesc": "Web3-first agents. Full blockchain integration, but no enforced tests.",
  "token.competitors.haystackDesc": "Best for RAG and search. Pipeline-based, but limited multi-agent support.",
  "token.competitors.difyDesc": "Visual builder for AI apps. No-code approach, but no type safety.",
  "token.competitors.conclusion": "VIBEE is the only framework with compile-time safety for vibe coding. @spec enforcement + BEAM runtime = production-ready agents without fear.",

  // Roadmap
  "token.roadmap.title": "Roadmap",
  "token.roadmap.q1.date": "0–6 months",
  "token.roadmap.q1.title": "Public release",
  "token.roadmap.q1.text": "DSL, documentation, first agent templates, 2–3 pilots.",
  ...
  "token.roadmap.q3.text": "Reach MRR, enterprise cases, partnerships with payment and AI platforms.",

  // Team
  "token.team.title": "Team",
  "token.team.founder.name": "Dmitry Vasiliev",
  "token.team.founder.bio": "Engineer and consultant in AI agents, devtools and digital clones. Experience building AI services, content marketing automation and DSL-based development approaches.",
  "token.team.hiring": "Planning to strengthen with expertise in fintech payments, enterprise sales and open-source community development.",
  ...
  "token.ask.use.item4": "Team strengthening (fintech, devrel, enterprise sales)",
  "token.ask.goal": "Round goal — reach sustainable MRR and 2–3 reference cases with real transactions within 18–24 months.",
...
const ru: Translations = {
  ...
  "hero.subtitle": "Социальная сеть для креаторов. AI генерирует профессиональные видео. Загрузи фото, опиши идею — получи готовый рилс.",
  "cta.try": "Попробовать",
  ...
  "feedPreview.subtitle": "Смотри, лайкай и вдохновляйся лучшими рилсами нашего сообщества",
  ...
  "features.reels.desc": "Опиши идею — получи сценарий, видео и озвучку за 2 минуты",
  "features.feed.title": "Лента креаторов",
  "features.feed.desc": "Смотри, лайкай и вдохновляйся лучшими рилсами сообщества",
  "features.avatars.title": "Говорящие аватары",
  "features.avatars.desc": "Создай цифрового двойника, который говорит твоим голосом",
  "features.analytics.title": "Аналитика",
  "features.analytics.desc": "Отслеживай охваты, вовлечённость и рост аудитории",
  ...
  "creatorShowcase.quote1": "VIBEE изменил мой контент. Теперь я делаю 5 рилсов в день!",
  "creatorShowcase.quote2": "AI-аватары просто невероятные. Моя аудитория в восторге.",
  "creatorShowcase.quote3": "Наконец инструмент, который делает профессиональное видео доступным всем.",
  ...
  "testimonials.quote1": "Раньше я тратила часы на монтаж. Теперь создаю рилс за 2 минуты. Это меняет всё!",
  "testimonials.quote2": "Продуктивность нашей команды выросла втрое. VIBEE экономит время и бюджет.",
  "testimonials.quote3": "AI-аватары выглядят так реалистично! Мои подписчики не могут отличить.",
  "testimonials.quote4": "Простой интерфейс, мощный результат. Рекомендую всем, кто создаёт контент.",
  ...
  "howItWorks.step2.desc": "Подбери аватар, голос, музыку и визуальный стиль рилса.",
  "howItWorks.step3.title": "Публикуй",
  "howItWorks.step3.desc": "Делись в Instagram, TikTok, YouTube или ленте VIBEE.",
  ...
  "token.hero.tagline": "Компилятор проверяет @spec. Встроенные платежи. BEAM fault tolerance. Accept All без страха.",
  "token.hero.description": "45% AI-кода содержит уязвимости. VIBEE компилирует AI-генерированный код в надёжных BEAM-агентов с обязательными @spec проверками и встроенным платёжным слоем. 10 строк VIBEE вместо 120 строк Java.",
  ...
  "token.hero.karpathy.quote": "\"Это даже не кодинг - я просто вижу, говорю, запускаю и копирую-вставляю, и это в основном работает.\"",
  "token.hero.karpathy.cite": "— Андрей Карпатый (придумал термин 'Vibe Coding', февраль 2025)",
  ...
  "token.killer.description": "Опишите поведение на простом языке. Получите готовый плагин с тестами, документацией и типобезопасностью. Это то, что делает VIBEE стоящим миллиарды.",
  ...
  "token.killer.how.step1.desc": "Опишите поведение на простом языке с тест-кейсами",
  ...
  "token.killer.how.step3.desc": "Функции, тесты, документация, типы - всё сгенерировано",
...
types:
  ...
  "token.vibe.definition": "Термин придумал Андрей Карпатый (OpenAI, Tesla) в феврале 2025. Разработчики полностью доверяют AI писать код, нажимая 'Accept All' не читая диффы. Быстро, но рискованно: 45% AI-кода содержит уязвимости.",
  ...
  "token.vibe.conclusion.text": "Правила встроены в грамматику языка, не в промпты.",

  // Origin Story
  "token.origin.title": "Я понял проблему vibe coding раньше, чем появился термин",
  "token.origin.ch1.title": "Vibe coding = полное доверие AI",
  "token.origin.ch1.quote": "\"Я работал с LLM-агентами задолго до термина 'vibe coding'. И каждый раз одна проблема: AI игнорирует правила, которые ты ему даёшь. Пишу 'сначала тесты' — он забывает. Снова и снова.\"",
  "token.origin.ch1.explanation": "Промпты не работают. Контекст теряется. Правила обходятся. Это и есть главная проблема vibe coding — нет enforcement.",
  "token.origin.ch2.title": "@spec = страховка для vibe coding",
  "token.origin.ch2.quote": "\"Когда ты нажимаешь Accept All в Cursor или Claude Code, AI-код попадает в компилятор VIBEE. Если нет @spec — код не скомпилируется. Физически невозможно задеплоить непротестированный агент.\"",
  ...
  "token.origin.ch3.quote": "\"AI редко добавляет retry, timeout, circuit breaker. В VIBEE это одна строка — декоратор. Accept All и получи production-ready код.\"",
  "token.origin.conclusion": "VIBEE — единственный DSL, где vibe coding становится безопасным. Правила в грамматике, не в промптах.",

  // Problem Section
  "token.problem.title": "Проблема vibe coding — AI-код в продакшене",
  "token.problem.security.title": "45% AI-кода с уязвимостями",
  "token.problem.security.text": "SQL Injection, XSS, Command Injection — топ ошибок LLM. Veracode 2025: почти половина AI-кода небезопасна.",
  "token.problem.hangover.title": "Vibe coding hangover",
  "token.problem.hangover.text": "SaaStr инцидент: AI-агент удалил production базу данных. Без проверок AI может сделать что угодно.",
  "token.problem.gap.title": "Comprehension gap",
  "token.problem.gap.text": "Разработчики не понимают AI-код, который деплоят. Когда ломается — не знают как чинить.",

  // Fail Section
  "token.fail.title": "Почему текущие фреймворки не подходят",
  "token.fail.config.title": "Config-файлы без гарантий",
  "token.fail.config.text": "Chaining-библиотеки не дают формальных гарантий поведения: промпт меняется — всё ломается.",
  "token.fail.tests.title": "Тесты не обязательны",
  "token.fail.tests.text": "Можно выкатить агента без единой проверки. Нет enforced TDD/BDD.",
  "token.fail.payments.title": "Платежи — отдельно",
  "token.fail.payments.text": "Платежи и безопасность всегда «прикручиваются» отдельно, нет единой модели для транзакций.",

  // Solution Section
  "token.solution.title": "Vibe-кодь смело — @spec поймает ошибки",
  "token.solution.p1.bold": "VIBEE — это DSL для безопасного vibe coding.",
  "token.solution.p1.text": "Когда AI генерирует код, он попадает в компилятор, который требует @spec для каждого tool/agent.",
  "token.solution.p2.text": "Ты можешь нажимать Accept All сколько угодно — если нет спецификации Given–When–Then,",
  "token.solution.p2.bold": "код физически не скомпилируется.",
  "token.solution.p3": "На выходе — production-ready агент на BEAM VM с 99.9999999% uptime. Даже vibe-coded.",

  // Code Comparison
  "token.code.title": "Vibe-кодь быстрее на VIBEE",
  "token.code.subtitle": "Меньше кода = меньше мест для AI-ошибок. 10 строк VIBEE vs 120 строк Java.",
  "token.code.note": "VIBEE автоматически генерирует boilerplate, обработку ошибок, retry-логику и типы. Разработчик пишет только бизнес-логику.",

  // Compilation
  "token.compilation.title": "Во что компилируется VIBEE",
  "token.compilation.subtitle": "VIBEE DSL → Gleam → BEAM bytecode. Посмотрите трансформацию.",
  ...
  "token.compilation.persistent": "Persistent state",
  "token.compilation.faultIsolation": "Fault isolation",
  "token.compilation.note": "10 строк VIBEE превращаются в ~30 строк типизированного Gleam кода с retry, cache, timeout и error handling. На выходе — отказоустойчивый BEAM процесс.",

  // Syntax Comparison
  "token.syntax.title": "🔬 Сравнение синтаксиса языка VIBEE",
  "token.syntax.subtitle": "Все 25 синтаксических возможностей с реальными примерами кода - Нажмите на вкладки для изучения",
  ...
  "token.syntaxShowcase.subtitle": "Мощные возможности, которые существуют только в VIBEE - дающие вам суперсилы, которых нет в других языках",

  // All Features List
  "token.allFeatures.title": "Полный список: Все 25 синтаксических возможностей VIBEE",
  "token.allFeatures.subtitle": "Каждая возможность, которая делает VIBEE уникальным",
  ...
  "token.uniqueFeature.4pipes.desc": "В большинстве языков 0-1 pipe оператор. В VIBEE их 4 специализированных варианта для разных случаев.",
  ...
  "token.uniqueFeature.52decorators.desc": "В большинстве языков 0-10 декораторов. В VIBEE 52 production-ready декоратора для AI агентов.",
  "token.uniqueFeature.operatorSections.title": "Секции операторов",
  "token.uniqueFeature.operatorSections.desc": "Частичное применение операторов - пишите (> 5) вместо fn(x) { x > 5 }",
  ...
  "token.decorators.subtitle": "AI редко добавляет retry, timeout, circuit breaker. В VIBEE — это одна строка. 12 декораторов, 6,500+ использований.",
  ...
  "token.decorators.spec.desc": "TDD-first: код не компилируется без спецификации (Given-When-Then)",
  "token.decorators.impl.usage": "1,484 использований",
  "token.decorators.impl.desc": "Маркер реализации после @spec. Связывает спецификацию с кодом.",
  "token.decorators.retry.usage": "188 использований",
  "token.decorators.retry.desc": "Автоматические повторы с exponential/linear/constant backoff",
  "token.decorators.timeout.usage": "170 использований",
  "token.decorators.timeout.desc": "Ограничение времени выполнения. Защита от зависших вызовов.",
  "token.decorators.circuit.usage": "138 использований",
  "token.decorators.circuit.desc": "Паттерн \"автоматический выключатель\" — защита от каскадных сбоев",
  "token.decorators.cache.usage": "158 использований",
  "token.decorators.cache.desc": "ETS-кеширование с TTL. Мгновенный доступ к горячим данным.",
  "token.decorators.builder.usage": "403 использования",
  "token.decorators.builder.desc": "Builder pattern + автоматический to_json() метод",
  "token.decorators.derive.usage": "231 использование",
  "token.decorators.derive.desc": "Автоматическая JSON сериализация/десериализация",
  "token.decorators.enum.usage": "137 использований",
  "token.decorators.enum.desc": "Авто to_string() / from_string() для перечислений",
  ...
  "token.decorators.llm.desc": "Подключение LLM провайдера. Поддержка 19+ моделей.",
  "token.decorators.telegram.usage": "150+ использований",
  "token.decorators.telegram.desc": "Telegram MTProto интеграция. Bot API и UserBot режимы.",
  "token.decorators.http.usage": "80+ использований",
  "token.decorators.http.desc": "Декларативные HTTP запросы. REST API за одну строку.",
  "token.decorators.paywall.usage": "50+ использований",
  "token.decorators.paywall.desc": "Платёжный шлюз перед действием. Крипта + фиат + Telegram Stars.",
  "token.decorators.fullExampleTitle": "Полный пример: Escrow-агент для маркетплейса",

  // Demo
  "token.demo.title": "Пример: агент для маркетплейса за 15 минут",
  "token.demo.intro": "Представьте маркетплейс цифровых услуг. Продавцы и покупатели общаются с агентом: он помогает подобрать исполнителя, согласовать цену, забронировать деньги в escrow и автоматически выплатить после выполнения задачи.",
  ...
  "token.demo.result": "Разработчик получает не «чатботик», а промышленный компонент, который можно пустить в оборот.",

  // Features
  "token.features.title": "Продукт — из чего состоит VIBEE",
  "token.features.dsl.title": "VIBEE DSL",
  "token.features.dsl": "Язык для описания логики и ограничений агента с обязательными спецификациями.",
  "token.features.beam.title": "BEAM Runtime",
  "token.features.beam": "Кластер с авто-рекавери, миллионами lightweight-процессов и 99.9999999% uptime.",
  "token.features.mcp.title": "MCP Native",
  "token.features.mcp": "Глубокие интеграции с Claude, Cursor и инструментами для разработчиков.",
  "token.features.payments.title": "Payments Layer",
  "token.features.payments": "Крипта, фиат, P2P escrow — под управлением агента по заданным правилам.",
  "token.features.devex.title": "Dev Experience",
  "token.features.devex": "CLI, SDK, one-command deploy, интеграции с CI/CD и тестовыми раннерами.",
  "token.features.rainbow.title": "Rainbow Bridge",
  "token.features.rainbow": "E2E тесты на реальных Telegram аккаунтах. Не моки — живые проверки.",

  // ICP
  "token.icp.title": "Для кого мы строим VIBEE",
  "token.icp.saas.badge": "B2B SaaS",
  "token.icp.saas": "Компании, которые хотят встроить агентов в свой продукт (support, sales, ops) с контролируемым поведением.",
  "token.icp.fintech.badge": "Финтех & Маркетплейсы",
  "token.icp.fintech.text": "Платформы с транзакциями, где агент должен управлять деньгами по строгим правилам.",
  "token.icp.agencies.badge": "Студии & Агентства",
  "token.icp.agencies.text": "Команды, которые строят кастомных AI-агентов для клиентов и хотят промышленный стек.",
  ...
  "token.moat.tdd.title": "Enforced TDD/BDD",
  "token.moat.tdd.text": "В архитектуру зашито требование спецификаций и тестов до компиляции.",
  "token.moat.payments.title": "Нативный слой платежей и escrow",
  "token.moat.payments.text": "Не просто «подключи Stripe», а единая модель денег в DSL.",
  "token.moat.templates.title": "Аккумуляция доменных шаблонов",
  "token.moat.templates.text": "Со временем VIBEE копит готовые «агенты по отраслям», усиливая moat.",

  // Business
  "token.business.title": "Как VIBEE зарабатывает",
  "token.business.saas.title": "Подписка (SaaS)",
  "token.business.saas.text": "Тарифы по количеству агентов, интеграций, транзакций и среде (dev/prod).",
  "token.business.month": "мес",
  "token.business.usage.title": "По использованию",
  "token.business.usage.text": "Небольшая комиссия с проходящих через агентов платежей и escrow-операций.",
  "token.business.enterprise.title": "Enterprise",
  "token.business.enterprise.text": "On-prem/частные кластеры, SLA, консалтинг и кастомные интеграции.",
  ...
  "token.market.p1": "Рынок AI-агентов растет с CAGR около 46%, а совокупный объём к 2034 году оценивается в $69 миллиардов.",
  "token.market.p2": "Инвесторы смещаются от «голых LLM» к инфраструктуре и devtools, которые позволяют делать надежные продукты поверх моделей.",
  ...
  "token.competitors.featuresCategory": "Features",
  "token.competitors.integration": "Integration",
  "token.competitors.langchainDesc": "Самый популярный LLM-фреймворк. Отличная экосистема, но нет compile-time safety.",
  "token.competitors.autogenDesc": "Multi-agent conversations. Сильная интеграция с Azure, но Python runtime.",
  "token.competitors.crewaiDesc": "Role-based multi-agent. Простой API, но только sequential workflows.",
  "token.competitors.elizaosDesc": "Web3-first агенты. Полная интеграция с блокчейнами, но без enforced tests.",
  "token.competitors.haystackDesc": "Лучший для RAG и поиска. Pipeline-based, но limited multi-agent support.",
  "token.competitors.difyDesc": "Visual builder для AI apps. No-code подход, но нет type safety.",
  "token.competitors.conclusion": "VIBEE — единственный фреймворк с compile-time safety для vibe coding. @spec enforcement + BEAM runtime = production-ready агенты без страха.",

  // Roadmap
  "token.roadmap.title": "Дорожная карта",
  "token.roadmap.q1.date": "0–6 месяцев",
  "token.roadmap.q1.title": "Публичный релиз",
  "token.roadmap.q1.text": "DSL, документация, первые шаблоны агентов, 2–3 пилота.",
  "token.roadmap.q2.date": "6–12 месяцев",
  "token.roadmap.q2.title": "Биллинг и маркетплейс",
  "token.roadmap.q2.text": "Usage-based, маркетплейс шаблонов, активный devrel.",
  "token.roadmap.q3.date": "12–24 месяца",
  "token.roadmap.q3.title": "Enterprise и партнерства",
  "token.roadmap.q3.text": "Выход на MRR, enterprise-кейсы, партнерства с платежными и AI-платформами.",

  // Team
  "token.team.title": "Команда",
  "token.team.founder.name": "Дмитрий Васильев",
  "token.team.founder.bio": "Инженер и консультант в области AI-агентов, devtools и цифровых клонов. Опыт построения AI-сервисов, автоматизации контент-маркетинга и создания DSL-подходов к разработке.",
  "token.team.hiring": "Планируется усиление экспертизой в финтех-платежах, enterprise-sales и развитии open-source-комьюнити.",
  ...
  "token.ask.goal": "Цель раунда — выйти на устойчивый MRR и 2–3 эталонных кейса по агентам с реальными транзакциями в течение 18–24 месяцев.",
