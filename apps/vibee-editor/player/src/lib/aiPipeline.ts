...
export const AI_PIPELINE_STAGES: readonly AiPipelineStage[] = [
  ...
  },
  {
    ...
    // ШАГ НАЗЫВАЕТСЯ ТЕМ, ЧТО ОН ДЕЛАЕТ. «Аватар» — это тип медиа (так же
    // зовётся дорожка монтажа и категория ассетов), а шаг оживляет фото
    // голосом, то есть делает липсинк. Одно слово на две разные вещи
    // заставляло догадываться, какая имеется в виду.
    labelRu: 'Липсинк',
    labelEn: 'Lipsync',
    emoji: '🙂',
  },
