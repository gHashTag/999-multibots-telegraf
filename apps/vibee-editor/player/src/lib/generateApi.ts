...
export async function generateImageViaReplicate(params: {
  ...
  if (prediction.status === 'processing' || prediction.status === 'starting') {
    ...
    for (let i = 0; i < maxAttempts; i++) {
      ...
      const pollResponse = await fetch(`/api/replicate/poll?url=${encodeURIComponent(getUrl)}`);
 ...
 */
export async function klingCreateVideo(params: KlingVideoParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/kling/video`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      prompt: params.prompt,
 ...
 */
export async function klingImageToVideo(params: KlingI2VParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/kling/i2v`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      image_url: params.imageUrl,
...
export async function klingGetTask(taskId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/kling/task/${taskId}`);
  return response.json();
}
...
export async function klingListTasks(): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/kling/tasks`);
  return response.json();
}
 ...
 */
export async function heygenCreateVideo(params: HeyGenVideoParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/heygen/video`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
...
export async function heygenListAvatars(): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/heygen/avatars`);
  return response.json();
}
...
export async function heygenListVoices(): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/heygen/voices`);
  return response.json();
}
 ...
 */
export async function heygenGetStatus(videoId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/heygen/status/${videoId}`);
  return response.json();
}
 ...
 */
export async function falNeuroPhoto(params: NeuroPhotoParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/fal/neuro-photo`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      prompt: params.prompt,
 ...
 */
export async function falFluxKontext(params: FluxKontextParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/fal/flux-kontext`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      prompt: params.prompt,
 ...
 */
export async function falNanoBanana(params: NanoBananaParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/fal/nano-banana`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      prompt: params.prompt,
...
export async function falGetStatus(requestId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/fal/status/${requestId}`);
  return response.json();
}
...
export async function falGetResult(requestId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/fal/result/${requestId}`);
  return response.json();
}
 ...
 */
export async function replicateLipsync(params: ReplicateLipsyncParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/replicate/lipsync`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 */
export async function replicateMorphing(params: ReplicateMorphingParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/replicate/morphing`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 */
export async function replicateFaceswap(params: ReplicateFaceswapParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/replicate/faceswap`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 */
export async function replicateUpscale(params: ReplicateUpscaleParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/replicate/upscale`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      image_url: params.imageUrl,
 ...
 */
export async function replicateTrainLora(params: ReplicateTrainLoraParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/replicate/train-lora`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 */
export async function openaiTranscribe(params: OpenAITranscribeParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/openai/transcribe`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      audio_url: params.audioUrl,
 ...
 */
export async function openaiVision(params: OpenAIVisionParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/openai/vision`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      image_url: params.imageUrl,
 ...
 */
export async function openaiImprovePrompt(params: OpenAIImprovePromptParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/openai/improve-prompt`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      prompt: params.prompt,
 ...
 */
export async function videoConcat(params: VideoConcatParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/video/concat`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 * Trim video
 */
export async function videoTrim(params: VideoTrimParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/video/trim`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      video_url: params.videoUrl,
 ...
 */
export async function videoWatermark(params: VideoWatermarkParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/video/watermark`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      video_url: params.videoUrl,
 ...
 */
export async function videoAddAudio(params: VideoAddAudioParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/video/add-audio`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      video_url: params.videoUrl,
 ...
 */
export async function videoExtractAudio(videoUrl: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/video/extract-audio`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
 ...
 */
export async function brollGenerate(params: BrollGenerateParams): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/broll/generate`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
 ...
 */
export async function brollListTemplates(category?: string): Promise<GenerateResult> {
  const url = category
 ...
 */
export async function voiceClone(params: VoiceCloneParams): Promise<GenerateResult> {
...
export async function hedraGetStatus(jobId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/hedra/status/${jobId}`);
  return response.json();
}
...
export async function hedraListJobs(): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/hedra/jobs`);
  return response.json();
}
...
export async function bflGetResult(taskId: string): Promise<GenerateResult> {
  const response = await fetch(`${API_URL}/api/bfl/result/${taskId}`);
  return response.json();
}
