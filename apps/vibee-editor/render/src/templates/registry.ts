...
export const TEMPLATE_CARDS: TemplateCard[] = [
  ...
  },
  {
    id: 'LeelaPlanReel',
    title: 'Лила · план',
    tagline: 'Один бросок, один план, одно наблюдение',
    about:
      'Рил про один план доски Лилы: чёрный фон со звёздами, титр Leela с золотой линией, пустой кубик, бросок шестёрки точками, белая доска-паутина 9×8 под наклоном без заливок (68 — Цветок Жизни), лотос-фишка, карточка плана с каноническим текстом и хвост «Здесь нет правильного ответа». Всё, что на экране, берётся из канона или из полей — шаблон ничего не сочиняет.',
    accent: '#e0b544',
    fields: [
      {
        key: 'plan',
        label: 'Номер плана (1–72)',
        kind: 'number',
        required: true,
        hint: 'Название, текст, ряд и змея/стрела подставятся из канона (инструмент leela_plan)',
        example: '6',
      },
      {
        key: 'lang',
      ...
      {
        key: 'hook',
        label: 'Крючок (≤12 слов)',
        kind: 'text',
        hint: 'Пусто — берётся готовый крючок канона или название плана',
      },
      {
        key: 'quote',
        label: 'Цитата из текста плана (≤220 знаков)',
        kind: 'text',
        hint: 'Пусто — первые предложения канонического описания',
      },
      {
        key: 'question',
        label: 'Один мягкий вопрос-наблюдение',
        kind: 'text',
        hint: 'Необязательно; пусто — акт пропускается',
      },
      { key: 'cta', label: 'Хвост', kind: 'text', hint: 'По умолчанию — утверждённый CTA' },
      { key: 'handle', label: 'Бот', kind: 'text', example: '@leela_chakra_ai_bot' },
      { key: 'url', label: 'Адрес', kind: 'text', example: 't27.ai/leela' },
    ],
    rules: [
      'Текст плана — только канон (leela_plan), не пересказ модели.',
      'Без цен, отзывов, обещаний результата, слов давления (стоп-лист).',
      'Кубик точками, доска 9×8 без заливок, 68 без цифры — Цветок Жизни.',
      'Название клетки не приписывать человеку («вы — Эгоизм» нельзя).',
    ],
  },
]
