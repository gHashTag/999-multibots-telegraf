...
export default defineConfig(({ command, mode }) => {
  ...
  const nodeBuiltins = [
    'fs', 'path', 'os', 'crypto', 'stream', 'http', 'https', 'url', 'util', 
    'zlib', 'querystring', 'net', 'tls', 'dns', 'events', 'buffer', 'assert', 
    'child_process', 'worker_threads', 'cluster', 'module', 'process', 'readline',
    'string_decoder', 'timers', 'tty', 'perf_hooks', 'fs/promises'
  ]
  ...
  return {
    ...
    build: {
      ...
      rollupOptions: {
        ...
        external: [
          ...
          ...nodeBuiltins,
          'telegraf', 'mongoose', '@supabase/supabase-js', 'node-fetch', 'archiver'
        ],
        plugins: [
    ...
    plugins: [
      ...
      nodePolyfills({
        ...
        include: ['path', 'fs', 'events', 'crypto', 'buffer', 'util', 'stream', 'http', 'url'],
