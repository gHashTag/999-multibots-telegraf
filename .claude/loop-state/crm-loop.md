...
- [ ] ВЫСОКОЕ. Подписку можно продать человеку РОВНО ОДИН РАЗ навсегда:
      `hasOpenSubscription` смотрит `cancelled_at IS NULL` и никогда не
      очищается. Моя правка, сегодняшняя.
