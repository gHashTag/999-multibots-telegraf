...
Отдельная аномалия: три строки, где вместо хоста base64-подобный мусор длиной
в сотню символов. Похоже на записанный не в то поле ключ или токен —
разбирать отдельно, но в `public_url` таких значений быть не должно.
