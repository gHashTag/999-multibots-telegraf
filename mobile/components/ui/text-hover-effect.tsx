        ...
        >
          {hovered && (
            <>
              ...
              <stop offset="25%" stopColor="var(--brand-color)" />
              <stop offset="50%" stopColor="var(--brand-color)" />
              <stop offset="75%" stopColor="var(--brand-color)" />
              <stop offset="100%" stopColor="var(--brand-color)" />
            </>
          )}
        </linearGradient>
