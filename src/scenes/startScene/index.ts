...
Or, if you prefer to go solo, click "Proceed to Subscription".`
    ...
    // Явно покидаем сцену, чтобы она не мешала последующим глобальным командам.
    // Обработчики action этой сцены должны были сработать ДО этого момента,
    // так как callback_query от инлайн-кнопок придет раньше, чем пользователь введет новую команду.
