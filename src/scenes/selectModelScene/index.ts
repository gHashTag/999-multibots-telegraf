  ...
  async ctx => {
    ...
    const message = isRu
      ? '🤖 Какую модель вы хотите обучить?\n\n' +
        ...
        '• ❗️ Если вы новичок, рекомендуем использовать модель FLUX ❗️\n' +
      ...
      : '🤖 Which model do you want to train?\n\n' +
        '1. FLUX - basic model\n' +
        '• ❗️ If you are a beginner, we recommend using the FLUX model ❗️\n' +
        '• Perfect for photorealistic images\n' +
        '• Fast processing\n' +
        '• Suitable for most tasks\n\n' +
        '2. FLUX PRO - advanced model\n' +
        '• ❗️ Recommended for professional use ❗️\n' +
