    ...
    await ctx.reply(message, {
      ...
      reply_markup: Markup.keyboard([
        [
          Markup.button.text(
            isRu
              ? getButtonTextsByMode('main_menu')?.ru || '🏠 Главное меню'
              : getButtonTextsByMode('main_menu')?.en || '🏠 Main menu'
          ),
        ],
      ]).resize().reply_markup,
    })
...
5️⃣ <b>Google Veo 3</b>\n
   - <b>Описание:</b> Флагманская модель Google для создания видео с аудио в 4K качестве. Это самая передовая модель, которая создает не только видео, но и синхронизированное аудио, включая диалоги, звуковые эффекты и фоновую музыку.\n
   - <b>Особенности:</b> 4K разрешение, встроенная генерация аудио, реалистичная анимация губ для диалогов, продвинутое понимание физики и длительные повествовательные последовательности.\n
   - <b>Применение:</b> Идеально для создания высококачественного контента, рекламных роликов, коротких фильмов и любых проектов, где требуется профессиональное качество видео с аудио.\n\n
...
5️⃣ <b>Google Veo 3</b>\n
   - <b>Description:</b> Google's flagship model for creating videos with audio in 4K quality. This is the most advanced model that creates not only video but also synchronized audio, including dialogue, sound effects, and background music.\n
   - <b>Features:</b> 4K resolution, built-in audio generation, realistic lip animation for dialogue, advanced physics understanding, and long narrative sequences.\n
   - <b>Application:</b> Perfect for creating high-quality content, commercials, short films, and any projects requiring professional video quality with audio.\n\n
