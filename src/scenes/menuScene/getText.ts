...
import { logger } from '@/utils/enhancedLogger'
  ru: {
    digitalAvatar: `🚀 Чтобы начать создавать нейрофотографии, вам нужно обучить ИИ модель на ваших фотографиях. Для этого оформите подписку на бота, чтобы получить доступ к этой функции!\n\nПредставь, как твои фотографии превращаются в стильные и современные произведения искусства, подчеркивая твою индивидуальность и выделяя из толпы.`,
