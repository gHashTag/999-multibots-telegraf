...
const botNameToTokenEnvMap: Record<string, string> = {
  ...
  ai_koshey_bot: 'BOT_TOKEN_TEST_2', // Тестовый бот 1 (используем TEST_2 для ai_koshey_bot)
  clip_maker_neuro_bot: 'BOT_TOKEN_TEST_1', // Тестовый бот 2 (используем TEST_1 для clip_maker_neuro_bot)
