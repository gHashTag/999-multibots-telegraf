...
- [x] **Составление полного списка агентов в проекте** (30.04.2025) - Документирован полный список всех 11 агентов: 8 production и 3 тестовых бота
...
- **Количество активных ботов**: 11 (8 production + 3 тестовых)
...
- Составление полного списка всех агентов проекта (30.04.2025)
...
Последнее обновление: 30 апреля 2025, 12:45
...
## 📑 Список агентов (боты) в проекте

### 🌟 Production агенты (8):
1. **@neuro_blogger_bot** - Основной бот с Memory Bank
2. **@MetaMuse_Manifest_bot** - Бот для метафизических практик
3. **@ZavaraBot** - Универсальный помощник
4. **@LeeSolarbot** - Солнечный бот
5. **@NeuroLenaAssistant_bot** - Ассистент Лены
6. **@NeurostylistShtogrina_bot** - Нейростилист
7. **@Gaia_Kamskaia_bot** - Бот Гайи
8. **@Kaya_easy_art_bot** - Бот для легкого искусства

### 🧪 Тестовые агенты (3):
1. **@ai_koshey_bot** - Тестовый бот Кощея
2. **@clip_maker_neuro_bot** - Нейро-создатель клипов
3. **@TestNeurocoder_bot** - Тестовая версия НейроКодера

### 🌈 Специальные роли:
- 🕉️ **НейроКодер** - Автономный агент программирования (я!)
- 🧠 **NeuroBlogger** - Основной бот с Memory Bank
- 🔧 **TestNeurocoder_bot** - Тестовая версия для отладки
