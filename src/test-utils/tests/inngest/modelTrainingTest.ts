 ...
 */
export async function testModelTraining(data?: Partial<ModelTrainingData>): Promise<TestResult> {
  ...
  const mockSendEvent = mock<(name: string, data: any) => Promise<ModelTestResult>>();
 ...
 */
export async function testModelTrainingV2(data?: Partial<ModelTrainingData>): Promise<TestResult> {
  const defaultData: ModelTrainingData = {
    bot_name: 'test_bot',
    is_ru: true,
