...
export async function testBroadcastMessage(): Promise<BroadcastTestResult[]> {
  ...
  try {
    ...
    results.push({
      testName: '✉️ Отправка простого текстового сообщения',
    ...
    results.push({
      testName: '🖼️ Отправка сообщения с изображением',
    ...
    results.push({
      testName: '🔘 Отправка сообщения с кнопками',
    ...
    results.push({
      testName: '❌ Ошибка тестирования broadcast message',
      success: false,
