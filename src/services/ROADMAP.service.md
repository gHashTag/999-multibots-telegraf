# 🚀 Сервисы: План рефакторинга и внедрения отказоустойчивости
...
- [ ] generateTextToImage.ts - Промпт из фото
...
### Обязательные компоненты для каждой функции
...
1. ✅ Создать общие утилиты в shared/
2. ✅ Определить типы в types/
3. ✅ Реализовать createModelTraining.ts
4. ✅ Написать тесты для createModelTraining
5. [ ] Начать работу над generateTextToImage.ts
6. [ ] Обновлять документацию
7. [ ] Расширять тестовое покрытие 
...
2. **План B: Прямое создание модели**
