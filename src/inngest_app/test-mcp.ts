...
class InngestMCPTester {
  ...
  private async testSendEvent() {
    ...
    try {
      ...
      this.addResult(testName, true, 'Event sent successfully', {
  ...
  private async testSimpleFunction() {
    ...
    try {
      ...
      this.addResult(testName, true, 'Function triggered successfully', {
        event_id: eventId,
  ...
  private async testErrorHandling() {
    ...
    try {
      ...
      this.addResult(testName, true, 'Error handling works correctly', {
        status: response.data.status,
