...
export const SUBSCRIPTION_CONFIG: Record<SubscriptionType, SubscriptionConfig> =
  {
    ...
    [SubscriptionType.NEUROMEETING]: {
      type: SubscriptionType.NEUROMEETING,
      title_ru: '🤝 НейроМитинг',
      title_en: '🤝 NeuroMeeting',
      price_ru: 2999,
      price_en: 29.99,
      description_ru: 'Подписка для митингов (скопировано с Нейробазы)',
      description_en: 'Subscription for meetings (copied from NeuroBase)',
      features_ru: [
        '✨ Все функции Нейрофото',
        '🎨 Продвинутые стили',
        '🔄 Приоритетная обработка',
