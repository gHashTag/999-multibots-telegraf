  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        en: '🎤 Lip Sync',
        icon: '🎤',
        mode: ModeEnum.LipSyncModelSelection,
        requiresSubscription: true,
        directScene: true, // Прямой переход в сцену выбора модели
      },
    ],
  },
  {
