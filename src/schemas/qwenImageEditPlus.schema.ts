...
// TypeScript types
export type QwenImageEditPlusInput = z.infer<
  typeof QwenImageEditPlusInputSchema
>
export type QwenImageEditPlusResponse = z.infer<
  typeof QwenImageEditPlusResponseSchema
>
...
export const QWEN_IMAGE_EDIT_PLUS_CONFIG = {
  ...
  description:
    'Advanced multi-image editing with improved consistency and ControlNet support',
  maxImages: 10,
...
// Validation function
export function validateQwenImageEditPlusInput(
  input: any
):
  | { success: true; data: QwenImageEditPlusInput }
