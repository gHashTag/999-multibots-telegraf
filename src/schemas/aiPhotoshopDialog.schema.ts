...
export const AIPhotoshopSizeEnum = z.enum(['1K', '2K', '4K', 'custom'])
...
export const DialogStateSchema = z
  .object({
    ...
    lastActivityTime: z
      .string()
      .datetime()
      .describe('Last user activity timestamp'),
...
export function validateDialogState(input: unknown) {
  try {
    ...
    console.log(
      '✅ [AI Photoshop Dialog] Dialog state validation successful:',
      {
...
export function validateSessionData(input: unknown) {
  try {
    ...
    console.log(
      '✅ [AI Photoshop Dialog] Session data validation successful:',
      {
        sessionId: validated.sessionId,
...
export function validateStateTransition(input: unknown) {
  try {
    ...
    console.log(
      '✅ [AI Photoshop Dialog] State transition validation successful:',
      {
    ...
    console.error(
      '🚨 [AI Photoshop Dialog] State transition validation FAILED:',
      {
        error:
          error instanceof Error ? error.message : 'Unknown validation error',
        receivedData:
...
export function validateErrorHandling(input: unknown) {
  try {
    ...
    console.log(
      '✅ [AI Photoshop Dialog] Error handling validation successful:',
      {
    ...
    console.error(
      '🚨 [AI Photoshop Dialog] Error handling validation FAILED:',
      {
        error:
          error instanceof Error ? error.message : 'Unknown validation error',
        receivedData:
