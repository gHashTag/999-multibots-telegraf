...
export type FluxKontextProResponse = z.infer<
  typeof FluxKontextProResponseSchema
>
 ...
 */
export const validateFluxKontextProInput = (
  input: unknown
): FluxKontextProInput => {
 ...
 */
export const validateFluxKontextProResponse = (
  output: unknown
